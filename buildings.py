class buildingFactory():
    ...
    def increaseQuantity(self, planet, quantity=1):
        ...
        for resource, value in self.construction.items():
            if (planet.resource[resource] - value) > 0:
                planet.resource[resource] -= value
            else:
                return False
